    ...
    override fun visitMethod(
        ...
        val methodVisitor = object : MethodVisitor(Opcodes.ASM9, super.visitMethod(access, name, descriptor, signature, exceptions)) {
            val methodSignature =
                ...
                //TODO(62555) how does it work with fields actually?
            ...
            override fun visitFieldInsn(opcode: Int, owner: String?, name: String?, descriptor: String?) {
                if (opcode == Opcodes.GETSTATIC && name == "INSTANCE") {
                    ...
                    context.methodToLocalClassUsages.getOrPut(methodSignature!!, { ArrayList<String>() }).add(owner!!)
                    //TODO fix !!
                    context.localClassStateSnapshots.put(owner!!, 0L)
                }
                super.visitFieldInsn(opcode, owner, name, descriptor)
            }

            override fun visitTypeInsn(opcode: Int, type: String?) {
                println("visitTypeInsn $type - do we care?")
